	...
	<div class="row">
		<div class="portlet ">		
			<div class="portlet-title">
				<div class="caption">
					Create Assembly Log <?php $assembyID =  $this->uri->slash_segment(4);$assembyID =  str_replace('/', '', @$assembyID);?> <b> <?php echo $assembyID ? '(' . $assembyID . ')' : "";?> </div>	<a href="<?php echo base_url('products/assembly')?>" class="btn btn-primary pull-right">Back</a>	
			</div>
				...
				<div class="table-container">
					<?php 
						if(!$assemblyLogData){
							...
							echo "<pre>";print_r($assemblyLogData); echo "</pre>";
						}
					?>
				</div>
			</div>
