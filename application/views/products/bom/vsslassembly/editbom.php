										...
										<td colspan="5" class="receipe" data-recipe="<?php echo $receipeid;?>">
											<table class="table table-striped table-bordered table-hover bomitems">
												<thead>
													<tr class="tableHead">
														...
														<th><label class="col-md-12">Price</label></th>
														<th>
											...
											<?php foreach ($billcomponent['items'] as $billcompo) { ?>
												<tr data-id="<?php echo $billcompo['id'];?>">
													...
													<td><span class="compPrice"><?php echo $billcompo['price']?></span></td>
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		...
		jQuery(document).on("click",".addcomponent",function(e){			
			...
			appendRow = '<tr><td width="30%"><input type="text" placeholder="Enter sku" class="atutocomplate form-control" name="data['+recipeId+'][sku][]"></td><td width="30%"><input type="text" placeholder="Enter name" class="name form-control" name="data['+recipeId+'][name][]"></td><td><span class="compPrice"></span></td><td ><input type="text" placeholder="Qty" class="qty form-control" style="width:100px;" name="data['+recipeId+'][qty][]"><a href="javascript:;" class="btn btn-circle yellow remvoerow pull-right"><i class="fa fa-close"></i></a><span class="addcomponentcontainer"></span></td></tr>';
			...
			jQuery(".atutocomplate").autocomplete({
				...
				select: function (event, ui) { 
					if(ui.item.value){
						...
						jQuery(this).closest("tr").find(".compPrice").html(productBySku[ui.item.value]['price']);
					}	
				},
